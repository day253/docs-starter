...
class BaseCartesia:
    ...
    environment : CartesiaEnvironment
        ...
        Defaults to CartesiaEnvironment.DEFAULT
    ...
    def __init__(
        ...
        *,
        ...
        environment: CartesiaEnvironment = CartesiaEnvironment.DEFAULT,
...
def _get_base_url(
    *, base_url: typing.Optional[str] = None, environment: CartesiaEnvironment
) -> str:
